package com.raf.rezervacioni_servis.secutiry;


import com.raf.rezervacioni_servis.secutiry.service.TokenService;
...
public class SecurityAspect {
   ...
   public SecurityAspect(TokenService tokenService){
    ...
    @Around("@annotation(com.raf.rezervacioni_servis.secutiry.CheckSecurity)")
